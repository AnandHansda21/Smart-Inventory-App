...
export function InputModal({ isOpen, onClose, editItem }: InputModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-end z-50 md:items-center md:justify-center">
      <div className="bg-card w-full max-w-none md:max-w-md rounded-t-2xl md:rounded-2xl flex flex-col max-h-[95vh] md:max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          <div className="overflow-y-auto flex-1 p-4 sm:p-6 pt-4 pb-2 space-y-4">
          ...
          <div className="flex gap-3 p-4 sm:p-6 pt-4 border-t border-border bg-card shrink-0">
            <Button
              type="button"
              variant="outline"
              onClick={handleClose}
